...
const rednerFooter = () =>
    (document.querySelector(
        "#footer"
    ).innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="fill white" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 367.467 367.467" xml:space="preserve">
<g>
